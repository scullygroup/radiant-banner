...
<!--
  TODO Need to modify find method to include the specified page for each ad and only pull ads assigned to that page
-->
...
<p>By default, the tool picks an Ad Seta and their associated Ad Banners at random, based on the page assigned.</p>

<p>There are 2 choices for displaying an Ad Set:  Static Ad Banners, or Ad Banners rotated in a Flash Slideshow.
...
<pre><code>
  <r:banners:each placement="header">
    <r:ads:each>
      <r:slideshow/>
    </r:ads:each>
  </r:banners:each>
